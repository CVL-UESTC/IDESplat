...
from ..encoder_idesplat import EncoderIDESplat
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_idesplat_cfg import EncoderVisualizerIDESplatCfg
...
class EncoderVisualizerIDESplat(
    EncoderVisualizer[EncoderVisualizerIDESplatCfg, EncoderIDESplat]
):
    def visualize(
        self,
