...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, out_channels=[256, 512, 1024, 1024], use_bn=False, use_clstoken=False, pretrained_dino=True):
        ...
        # else:
        self.pretrained = torch.hub.load('facebookresearch/dinov2', 'dinov2_{:}14'.format(encoder), pretrained=pretrained_dino, source='local')
        # self.pretrained = torch.hub.load('/data0/home/longwei/.cache/torch/hub/facebookresearch_dinov2_main/dinov2', 'dinov2_{:}14'.format(encoder), pretrained=pretrained_dino, source='local')
